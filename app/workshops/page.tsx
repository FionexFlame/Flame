      ...
      <Container>
        <div className="py-16 sm:py-20">
          ...
          <div className="mt-12 rounded-3xl bg-ink-900/40 shadow-edge p-7">
            <p className="text-xs uppercase tracking-[0.22em] text-bone-100/45">How this scales</p>
            <p className="mt-3 text-bone-100/80 leading-relaxed max-w-3xl">
              Later you can add ticketing (Eventbrite), payments (Stripe), or applications—
